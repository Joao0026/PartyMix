...
export const SIPS_WEIGHTS=[{value:1,weight:20},{value:2,weight:35},{value:3,weight:25},{value:'meio copo',weight:12},{value:'copo inteiro',weight:5},{value:'dobro p/ grupo',weight:3}]
export function weightedSips(){const t=SIPS_WEIGHTS.reduce((s,w)=>s+w.weight,0);let r=Math.random()*t;for(const w of SIPS_WEIGHTS){if(r<w.weight)return w.value;r-=w.weight}}
