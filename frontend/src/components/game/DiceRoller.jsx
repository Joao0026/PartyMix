  ...
  return(
    <div className="flex flex-col items-center gap-4">
      <motion.div onClick={state==='idle'&&!disabled?roll:undefined}
        animate={state==='rolling'?{rotateX:[0,360,720],rotateY:[0,180,360,540],scale:[1,1.1,0.95,1.1,1]}:state==='result'?{scale:[1.2,1]}:{}}
        transition={state==='rolling'?{duration:0.85,ease:'easeInOut'}:{duration:0.3,type:'spring'}}
        style={{cursor:state==='idle'&&!disabled?'pointer':'default',perspective:800}}
