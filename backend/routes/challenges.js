...
router.post('/', requireAdmin, asyncRoute(async (req, res) => {
  const payload = {
    ...
    correct_question: cleanString(req.body.correct_question, { field: 'correct_question', max: 300 }),
    wrong_question: cleanString(req.body.wrong_question, { field: 'wrong_question', max: 300 }),
  };
