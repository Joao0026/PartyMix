...
const s = new mongoose.Schema({
  ...
  category: { type: String, enum: ['telepatia','perguntas','desenho','mimica','proibido','caos','palavra','acao','verdade','consequencia','cultura','desporto','musica','cinema','erotico','romantico','picante','roleplay','casal_pergunta','dados'], required: true },
